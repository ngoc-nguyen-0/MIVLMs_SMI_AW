...
GPU_ID=0,1
task_name=StanfordDogs # choose from: Biden_base_Trump_target, healthyFood_base_hamburgerFries_target, kidSports_base_kidVideoGame_target, lowFuelLight_base_engineLight_target
...
#############3 llava-v1.5-7b
data_path=StanfordDogs_train.json
data_root=/home/ngocntb/stanford_dogs/Images/
model=liuhaotian/llava-v1.6-vicuna-7b
output_dir=$SAVE_ROOT/checkpoints/llava-v1.6-vicuna-7b_StanfordDogs/$model/
...
#     --report_to wandb
 ...
 CUDA_VISIBLE_DEVICES=0 python model_vqa_our.py \
    --model_name "llava-v1.6-vicuna-7b_StanfordDogs" \
    --image-folder "/home/ngocntb/stanford_dogs/Images/" \
    --question-file "StanfordDogs_test.json" \
    --answers-file "./results/llava-v1.6-vicuna-7b_StanfordDogs_test.json"



# #############3 liuhaotian/llava-v1.5-13b
# data_path=facescrub_train_new.json
