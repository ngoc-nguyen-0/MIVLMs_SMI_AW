...
#     --image-folder "/home/users/ngocntb2/facescrub/" \
#     --question-file "facescrub_test.json" \
#     --answers-file "./results/llava-v1.6-vicuna-7b_facescrub_90_test_results_our_transform.json"
 ...
 CUDA_VISIBLE_DEVICES=4 python model_vqa_our.py \
    ...
    --image-folder "/home/users/ngocntb2/facescrub/" \
    --question-file "facescrub_test.json" \
    --answers-file "./results/llava-v1.6-vicuna-7b_facescrub_90_test_results_our_transform_2.json"
